...
2021-11-07 : Peter Hyman (lrzip-next)
	This file will contain the function GetMatchesSpecN_2 if Assembler is not used.
	Eliminated large batches of comment blocks for readability.
*/
