...
lrzn - gzip compatible command line variant of lrzip-next


=head1 SYNOPSIS

B<lrzn> [options] I<file>


=head1 DESCRIPTION

B<lrzn> is identical to the B<lrzip-next> application, however, its command
...
See also lrzip-next(1)

=head1 ENVIRONMENT

lrzn uses the same environment and configuration files as lrzip-next(1)
